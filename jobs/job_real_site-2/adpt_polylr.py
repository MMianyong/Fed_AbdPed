...
class PolyLRScheduler(_LRScheduler):
    def __init__(self, optimizer, initial_lr: float, max_steps: int, exponent: float = 0.9, current_step: int = None,yaml_file: str = "./site-2/job_real_site-2/exp_set.yaml"):
    ...
    def step(self, current_step=None):
        ...
        total_rounds=int(exp_set['total_rounds'])
